...
class PresentationPowerfit extends StatefulWidget {
  final String producName;
  final String path;

  PresentationPowerfit({super.key, required this.producName, required this.path});

  @override
  State<PresentationPowerfit> createState() => _PresentationPowerfitState();
}

class _PresentationPowerfitState extends State<PresentationPowerfit> {
  final List<String> videoUrls = [
    "https://youtube.com/shorts/6frsctV0MN4?feature=share"
  ];
                  ...
                  child: Container(
                    ...
                    child: Center(
                      child: Container(
                          ...
                          child: TextComponent(text: "PowerFit",fontWeight: FontWeight.bold,color: Colors.white,)),
                    ),
                  ),
                ),
              ],
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  Center(
                    child: TextComponent(
                      text: "Conseils d'utilisation powerfit",
                      fontWeight: FontWeight.bold,
                    ),
                  ),
                  YoutubePlayer(
